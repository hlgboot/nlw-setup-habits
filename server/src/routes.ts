...
export async function routes(app: FastifyInstance) {
    ...
    app.get("/day", async (req, res) => {
        ...
        const day = await prisma.day.findUnique({ where: { date }, include: { dayHabits: true}})
    ...
    app.patch("/habits/:id/toggle", async (req, res) => {
        ...
        const dayHabit = await prisma.dayHabit.findUnique({ where: { day_id_habit_id: { day_id: day.id, habit_id: id } } })
